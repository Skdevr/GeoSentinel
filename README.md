...
O GeoSentinel foi projetado para ser agnóstico ao provedor de IA, permitindo a utilização de modelos open-weight ou APIs comerciais conforme o caso de uso.
...
A seleção definitiva dos modelos ocorrerá durante a evolução do projeto, considerando critérios como desempenho, custo, capacidade multimodal, janela de contexto, facilidade de implantação e requisitos de licenciamento.
...
-   OpenID Connect
-   Keycloak
-   Policy Agent (OPA) como planejamento futuro
